...
public class DeleteZone extends ImageView implements DropTarget, DragController.DragListener {
    ...
    public void onDrop(DragSource source, int x, int y, int xOffset, int yOffset,
        ...
        if (item.container == -1 && item.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION && item instanceof ApplicationInfo) {
            LauncherModel.deleteApplication(mLauncher, (ApplicationInfo)item);
            return;
        }
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        if (item != null) {
             ...
             * ��ͨ��getRight()\getLeft()\getBottom()\getTop()������
             * modify by author
             */
