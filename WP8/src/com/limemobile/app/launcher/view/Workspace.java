...
//        mNextIndicator.setLevel(mCurrentScreen);
        mIndicator.setIndicator(mCurrentScreen);
    ...
    private void updateWallpaperOffset() {
    	/**
    	 * mRight��mLeft���Ǳ�����Ա���޷�ֱ�ӷ��� modify by author
    	 */
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
        	/**
        	 * mScrollX �Ǳ������ԣ����ܿ����ʣ�ʹ��scrollTo(int��int) modify by author
        	 */
            ...
            mSmoothingTime = System.nanoTime() / NANOTIME_DIV;
        	/**
        	 * mScrollY �Ǳ������ԣ����ܿ����ʣ�ʹ��scrollTo(int��int) modify by author
        	 */
...
//            mNextIndicator.setLevel(mCurrentScreen);
        	...
        	/**
        	 * mScrollX �Ǳ������ԣ����ܿ����ʣ�ʹ��scrollBy(int��int) modify by author
        	 */
            //mScrollX += dx * e;
            scrollBy((int)(dx * e), 0);
            mSmoothingTime = now;
...
//    }
    public void setIndicator(IndicatorView indicator) {
    	...
    	mIndicator.setTotalCount(getChildCount());
    	mIndicator.setIndicator(mCurrentScreen);
    }
