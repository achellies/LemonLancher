...
import com.limemobile.app.launcher.common.SymmetricalLinearTween;
import com.limemobile.app.launcher.common.TweenCallback;
...
public class DragView extends View implements TweenCallback {
    ...
    public DragView(Context context, Bitmap bitmap, int registrationX, int registrationY,
        ...
        /**
         * WindowManagerImpl��WindowManager�ľ���ʵ�֣�����hide
         * �ñ�׼�����滻
         * modify by author
         */
