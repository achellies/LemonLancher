 ...
 */
public class ApplicationInfo extends ItemInfo implements Comparable<ApplicationInfo> {
    ...
    /**
     * Whether the application is system application
     */
    ...
    public ApplicationInfo(ResolveInfo info, IconCache iconCache) {
        ...
        ascii = PinyinUtil.toString(title.toString());
        
        isSystem = (info.activityInfo.applicationInfo.flags & android.content.pm.ApplicationInfo.FLAG_SYSTEM) == android.content.pm.ApplicationInfo.FLAG_SYSTEM;
    }
    ...
    public int compareTo(ApplicationInfo another) {
        return this.ascii.compareTo(another.ascii);
    }
}
