...
import com.limemobile.app.launcher.common.AllAppsList;
import com.limemobile.app.launcher.common.DeferredHandler;
...
public class LauncherModel extends BroadcastReceiver {
     ...
     */
    public static void deleteApplication(Context context, ApplicationInfo info) {
        Uri uri = Uri.fromParts("package", info.componentName.getPackageName(), null);
        ...
        private void loadAllAppsByBatch() {
            ...
            while (i < N && !mStopped) {
                if (i == 0) {
                    ...
                    Collections.sort(apps, new DisplayNameComparatorEx(packageManager));
        ...
        if (!info.customIcon && !info.usingFallbackIcon) {
            ...
            try {
                if (data != null) {
                    ...
                    /**
                     * sameAs���Ǳ�׼SDK needSave��ֵΪfalse modify by author
                     */
	...
	public static class DisplayNameComparatorEx implements
			Comparator<ResolveInfo> {
		public DisplayNameComparatorEx(PackageManager pm) {
			mPM = pm;
		}

		public final int compare(ResolveInfo a, ResolveInfo b) {        
			boolean aSys = (a.activityInfo.applicationInfo.flags & android.content.pm.ApplicationInfo.FLAG_SYSTEM) == android.content.pm.ApplicationInfo.FLAG_SYSTEM;
			boolean bSys = (b.activityInfo.applicationInfo.flags & android.content.pm.ApplicationInfo.FLAG_SYSTEM) == android.content.pm.ApplicationInfo.FLAG_SYSTEM;
