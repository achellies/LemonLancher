...
public class MenuPopupHelper implements AdapterView.OnItemClickListener,
	...
	public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView,
		...
		mPopupMaxWidth = Math
				.max(res.getDisplayMetrics().widthPixels / 2,
	...
	public boolean tryShow() {
		...
		mPopup.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.menu_dropdown_panel_holo_dark));
		...
		mPopup.show();
		mPopup.getListView().setDivider(mContext.getResources().getDrawable(R.drawable.list_selector_line1));
	...
	// OnAttachedStateChangeListener is defined in API 12. Trying with it
	// commented out,
	// to allow supporting older versions.
