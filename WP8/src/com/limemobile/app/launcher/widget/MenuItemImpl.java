...
import com.limemobile.app.launcher.widget.MenuView.ItemView;
...
//	private OnActionExpandListener mOnActionExpandListener;
	...
	MenuItemImpl(MenuBuilder menu, int group, int id, int categoryOrder,
		...
		/*
		 * if (sPrependShortcutLabel == null) { // This is instantiated from the
		 * UI thread, so no chance of sync issues sPrependShortcutLabel =
