 ...
 */
public class Hanzi2Pinyin14 {
	private static final String TAG = "Hanzi2Pinyin";
	...
	private static Hanzi2Pinyin14 sInstance;
	private final boolean mHasChinaCollator;

	protected Hanzi2Pinyin14(boolean hasChinaCollator) {
		mHasChinaCollator = hasChinaCollator;
	}

	public static Hanzi2Pinyin14 getInstance() {
		synchronized (Hanzi2Pinyin14.class) {
			if (sInstance != null) {
				return sInstance;
			}
			...
			for (int i = 0; i < locale.length; i++) {
				if (locale[i].equals(Locale.CHINA)) {
					...
					sInstance = new Hanzi2Pinyin14(true);
					return sInstance;
				}
			}
			Log.w(TAG,
					"There is no Chinese collator, HanziToPinyin is disabled");
			sInstance = new Hanzi2Pinyin14(false);
			return sInstance;
		}
	}
