...
package com.limemobile.app.launcher.provider;
...
//import com.android.internal.util.XmlUtils; modify by author
import com.limemobile.app.launcher.activity.Launcher;
import com.limemobile.app.launcher.common.LauncherSettings;
import com.limemobile.app.launcher.common.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.limemobile.app.launcher.wp8";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private int loadFavorites(SQLiteDatabase db) {
            ...
            try {
                ...
                /**
                 * XmlUtils���Ǳ�׼SDK modify by author
                 */
        ...
        private ComponentName getSearchWidgetProvider() {
            ...
            /**
             * getGlobalSearchActivity��searchManager��ʾΪhide״̬����Ȼ��public��������SDK 
             * modify by author
             */
