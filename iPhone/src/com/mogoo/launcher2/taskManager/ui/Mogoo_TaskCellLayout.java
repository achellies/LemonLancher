...
public class Mogoo_TaskCellLayout extends ViewGroup {
    
    private final static String TAG = "Launcher.Mogoo_TaskCellLayout" ;
    ...
    public Mogoo_TaskCellLayout(Context context) {
        this(context, null);
    }

    public Mogoo_TaskCellLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Mogoo_TaskCellLayout(Context context, AttributeSet attrs, int defStyle) {
...
//        Log.d(TAG, "heightSpecSize="+heightSpecSize+" widthSpecSize="+widthSpecSize) ;
        
//        Log.d(TAG, "mShortAxisStartPadding="+mShortAxisStartPadding+" mShortAxisEndPadding="+mShortAxisEndPadding) ;

        if (mPortrait) {
            int vSpaceLeft = heightSpecSize - longAxisStartPadding - longAxisEndPadding
                    - (cellHeight * longAxisCells);
            
//            Log.d(TAG, "heightSpecSize="+heightSpecSize+" longAxisStartPadding="+longAxisStartPadding+" longAxisEndPadding="+longAxisEndPadding+" cellHeight="+cellHeight+" longAxisCells="+longAxisCells+" vSpaceLeft="+vSpaceLeft) ;
...
//            Log.d(TAG, "widthSpecSize="+widthSpecSize+" shortAxisStartPadding="+shortAxisStartPadding+" shortAxisEndPadding="+shortAxisEndPadding+" cellWidth="+cellWidth+" shortAxisCells="+shortAxisCells+" hSpaceLeft="+hSpaceLeft) ;
...
out:            for (int i = x; i < x + spanX - 1 && x < xCount; i++) {
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new Mogoo_TaskCellLayout.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof Mogoo_TaskCellLayout.LayoutParams;
    }

    @Override
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new Mogoo_TaskCellLayout.LayoutParams(p);
    }
    ...
    static final class CellInfo implements android.view.ContextMenu.ContextMenuInfo {
        /**
