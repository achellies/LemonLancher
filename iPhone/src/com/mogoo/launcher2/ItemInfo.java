   ...
   //****************add by 张永辉*********************** end 
    ...
    void onAddToDatabase(ContentValues values) { 
        ...
        if (!isGesture) {
            ...
            //add by 张永辉 2010-12-29
            values.put(LauncherSettings.Favorites.IS_SYSTEM, isSystem);
            values.put(LauncherSettings.Favorites.APP_TYPE, appType);
            //end 
        }
    }
