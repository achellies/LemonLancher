...
// TODO: TableMaskFilter在源码中定义为hidden,需要在android源码下编译
/**
...
final class Utilities {
    ...
    static Bitmap createIconBitmap(Drawable icon, Context context) {
        return Mogoo_BitmapUtils.createIconBitmap(icon, context, true);
    ...
    static void drawSelectedAllAppsBitmap(Canvas dest, int destWidth, int destHeight,
        ...
        synchronized (sCanvas) { // we share the statics :-(
            ...
            dest.drawBitmap(mask, px + xy[0], py + xy[1], pressed ? sGlowColorPressedPaint
        ...
        BubbleText(Context context) {
            ...
            if (false) {
                Log.d(TAG, "mBitmapWidth=" + mBitmapWidth + " mBitmapHeight=" + mBitmapHeight
                        + " w=" + ((int) (mBubbleRect.width() + 0.5f)) + " h="
